...
/* Rétegek: éjszakai gradiens (tartalék) → fesztiválfotó (karmazsin duotón) → fátyol a
   borszínű alapba → tartalom, benne a vendégportré eredeti színekben, szűrő nélkül. */
  ...
  return (
    <section id="top" className={styles.hero}>
      ...
      <div className={styles.content}>
        {/* Cím-blokk: asztalon a portré abszolút, jobbra lent; telefonon a cím
            mellett ül egy keskenyebb oszlop mellett. */}
